...
def _get_agent(
  ...
  if _AGENT_NAME.value == 'gui_owl':
    agent = gui_owl.GUIOwl(env, infer_ma3.GUIOwlWrapper(_API_KEY.value, _BASE_URL.value, _MODEL.value), "qwen-vl", api_key=None, url=None, output_path=(_TRAJ_OUTPUT_PATH.value))
