...
!function(a, b, c, d) {
  ...
  var e = a.fn.twbsPagination, f = function(b, c) {
    ...
    var d = 'function' == typeof this.$element.prop ?
  ...
  f.prototype = {
    constructor: f,
    destroy: function() {
      return this.$element.empty(), this.$element.removeData('twbs-pagination'),
             this.$element.off('page'), this
    },
    show: function(a) {
      if (a < 1 || a > this.options.totalPages)
        throw new Error('Page is incorrect.');
      return this.currentPage = a, this.render(this.getPages(a)),
             this.setupEvents(), this.$element.trigger('page', a), this
    },
    enable: function() {
    ...
    buildListItems: function(a) {
      var b = [];
      if (this.options.first && b.push(this.buildItem('first', 1)),
          this.options.prev) {
        var c = a.currentPage > 1 ? a.currentPage - 1 :
            this.options.loop     ? this.options.totalPages :
                                    1;
      ...
      if (this.options.next) {
        var e = a.currentPage < this.options.totalPages ? a.currentPage + 1 :
            this.options.loop                           ? 1 :
    ...
    buildItem: function(b, c) {
      var d = a('<li></li>'), e = a('<a></a>'),
          f = this.options[b] ? this.makeText(this.options[b], c) : c;
      return d.addClass(this.options[b + 'Class']), d.data('page', c),
             d.data('page-type', b),
             d.append(e.attr('href', this.makeHref(c))
                          .addClass(this.options.anchorClass)
                          .html(f)),
             d
    },
    getPages: function(a) {
      var b = [], c = Math.floor(this.options.visiblePages / 2),
          d = a - c + 1 - this.options.visiblePages % 2, e = a + c;
    ...
    setupEvents: function() {
      ...
      this.$listContainer.off('click').on('click', 'li', function(c) {
        var d = a(this);
        return !d.hasClass(b.options.disabledClass) &&
    ...
    makeText: function(a, b) {
      return a.replace(this.options.pageVariable, b)
    ...
    getPageFromQueryString: function(a) {
      var b = this.getSearchString(a),
          ...
          d = c.exec(b);
      return d && d[2] ?
          (d = decodeURIComponent(d[2]), d = parseInt(d), isNaN(d) ? null : d) :
          null
    },
  ...
  a.fn.twbsPagination =
      function(b) {
    var c, e = Array.prototype.slice.call(arguments, 1), g = a(this),
           h = g.data('twbs-pagination'), i = 'object' == typeof b ? b : {};
    return h || g.data('twbs-pagination', h = new f(this, i)),
           'string' == typeof b && (c = h[b].apply(h, e)), c === d ? g : c
  },
