 ...
 * jquery.ui.spinner.js, jquery.ui.tabs.js, jquery.ui.tooltip.js Copyright 2014
 * jQuery Foundation and other contributors; Licensed MIT */
(function(t, e) {
function i(e, i) {
  var n, o, a, r = e.nodeName.toLowerCase();
  return 'area' === r ?
      (n = e.parentNode, o = n.name,
       e.href && o && 'map' === n.nodeName.toLowerCase() ?
           (a = t('img[usemap=#' + o + ']')[0], !!a && s(a)) :
           !1) :
      (/input|select|textarea|button|object/.test(r) ? !e.disabled :
           'a' === r                                 ? e.href || i :
                                                       i) &&
          s(e)
}
  ...
  keyCode: {
    ...
    t.fn.extend({
      ...
      scrollParent: function() {
        var e;
        return e = t.ui.ie && /(static|relative)/.test(this.css('position')) ||
    ...
    (t.fn.removeData =
         function(e) {
           return function(i) {
             return arguments.length ? e.call(this, t.camelCase(i)) :
                                       e.call(this)
           }
         }(t.fn.removeData)),
...
t
  ...
  n(e)
   ...
   t.widget =
     ...
     i = i.split('.')[1], o = c + '-' + i, n || (n = s, s = t.Widget),
     t.expr[':'][o.toLowerCase()] =
         function(e) {
       return !!t.data(e, o)
     },
     t[c] = t[c] || {}, a = t[c][i],
     ...
     h = new s, h.options = t.widget.extend({}, h.options),
     t.each(
         n,
         function(i, n) {
           return t.isFunction(n) ? (l[i] = function() {
             ...
             return function() {
               ...
               return this._super = t, this._superApply = e,
                      i = n.apply(this, arguments), this._super = s,
                      this._superApply = o, i
             }
           }(), e) : (l[i] = n, e)
         }),
     r.prototype = t.widget.extend(
         h, {widgetEventPrefix: a ? h.widgetEventPrefix || i : i}, l,
   ...
   t.widget.extend =
     ...
     for (var n, o, a = s.call(arguments, 1), r = 0, h = a.length; h > r; r++)
       for (n in a[r])
         o = a[r][n],
         a[r].hasOwnProperty(n) && o !== e &&
             (i[n] = t.isPlainObject(o) ? t.isPlainObject(i[n]) ?
   ...
   t.widget.bridge =
     ...
     t.fn[i] = function(a) {
       ...
       return a = !r && h.length ? t.widget.extend.apply(null, [a].concat(h)) :
                                   a,
   ...
   t.Widget.prototype = {
     ...
     _createWidget: function(e, s) {
       s = t(s || this.defaultElement || this)[0], this.element = t(s),
       this.uuid = i++, this.eventNamespace = '.' + this.widgetName + this.uuid,
       this.options =
     ...
     _on: function(i, s, n) {
       ...
       'boolean' != typeof i && (n = s, s = i, i = !1),
           n ? (s = o = t(s), this.bindings = this.bindings.add(s)) :
      ...
      _mouseDown: function(i) {
        if (!e) {
          ...
          var s = this, n = 1 === i.which,
              o = 'string' == typeof this.options.cancel && i.target.nodeName ?
              ...
              (this.mouseDelayMet = !this.options.delay,
               this.mouseDelayMet ||
                   (this._mouseDelayTimer = setTimeout(
                        ...
                        this.options.delay)),
               this._mouseDistanceMet(i) && this._mouseDelayMet(i) &&
                   ...
                   (!0 ===
                        ...
                        t.removeData(
                            i.target, this.widgetName + '.preventClickEvent'),
                    this._mouseMoveDelegate =
                        function(t) {
...
t.widget('ui.draggable', t.ui.mouse, {
  ...
  _createHelper: function(e) {
    var i = this.options,
        s = t.isFunction(i.helper) ? t(i.helper.apply(this.element[0], [e])) :
  ...
  _setContainment: function() {
    ...
    return n.containment ?
        ...
        (this.containment =
             [
               0, 0,
               t(document).width() - this.helperProportions.width -
                   this.margins.left,
               ...
               (this.containment &&
                ...
                a.grid &&
                    (n = a.grid[1] ? this.originalPageY +
                             Math.round((l - this.originalPageY) / a.grid[1]) *
                                 a.grid[1] :
                                     this.originalPageY,
                     l = i ? n - this.offset.click.top >= i[1] ||
                                 n - this.offset.click.top > i[3] ?
                             n :
                             n - this.offset.click.top >= i[1] ? n - a.grid[1] :
                                                                 n + a.grid[1] :
                             n,
                     o = a.grid[0] ? this.originalPageX +
                             Math.round((h - this.originalPageX) / a.grid[0]) *
                                 a.grid[0] :
                                     this.originalPageX,
  ...
  _trigger: function(e, i, s) {
    return s = s || this._uiHash(), t.ui.plugin.call(this, e, [i, s]),
           'drag' === e &&
      ...
      stop: function(e, i) {
        ...
        t.each(s.sortables, function() {
          this.instance.isOver ?
              (this.instance.isOver = 0, s.cancelHelperRemoval = !0,
 ...
 o ? (this.instance.isOver ||
              (this.instance.isOver = 1,
               this.instance.currentItem = t(n).clone()
                                               .removeAttr('id')
               ...
               s._trigger('toSortable', e), s.dropped = this.instance.element,
               s.currentItem = s.element, this.instance.fromOutside = s),
     ...
     this.instance.isOver &&
                  (this.instance.isOver = 0,
                   ...
                   this.instance._trigger(
                       'out', e, this.instance._uiHash(this.instance)),
                 ...
                 (i.overflowOffset.top + i.scrollParent[0].offsetHeight -
                      ...
                      e.pageY - i.overflowOffset.top < s.scrollSensitivity &&
                          (i.scrollParent[0].scrollTop = n =
                               i.scrollParent[0].scrollTop - s.scrollSpeed)),
             s.axis && 'y' === s.axis ||
                 (i.overflowOffset.left + i.scrollParent[0].offsetWidth -
                              e.pageX <
                          s.scrollSensitivity ?
             ...
             s.axis && 'y' === s.axis ||
                 (e.pageX - t(document).scrollLeft() < s.scrollSensitivity ?
                      ...
                      t(window).width() - (e.pageX - t(document).scrollLeft()) <
                          ...
                          (n = t(document).scrollLeft(
                               t(document).scrollLeft() + s.scrollSpeed)))),
            n !== !1 && t.ui.ddmanager && !s.dropBehaviour &&
    ...
    t.ui.plugin.add('draggable', 'snap', {
      ...
      drag: function(e, i) {
        var s, n, o, a, r, h, l, c, u, d,
            p = t(this).data('ui-draggable'), f = p.options,
            g = f.snapTolerance, m = i.offset.left,
            v = m + p.helperProportions.width, _ = i.offset.top,
            b = _ + p.helperProportions.height;
        for (u = p.snapElements.length - 1; u >= 0; u--)
          r = p.snapElements[u].left, h = r + p.snapElements[u].width,
          l = p.snapElements[u].top, c = l + p.snapElements[u].height,
          r - g > v || m > h + g || l - g > b || _ > c + g ||
                  !t.contains(
              ...
              (p.snapElements[u].snapping && p.options.snap.release &&
                   p.options.snap.release.call(
                       p.element, e,
                       t.extend(
                           p._uiHash(), {snapItem: p.snapElements[u].item})),
               p.snapElements[u].snapping = !1) :
              ('inner' !== f.snapMode &&
                   (s = g >= Math.abs(l - b), n = g >= Math.abs(c - _),
                    o = g >= Math.abs(r - v), a = g >= Math.abs(h - m),
                    s &&
                        (i.position.top =
               ...
               d = s || n || o || a,
               'outer' !== f.snapMode &&
                   (s = g >= Math.abs(l - _), n = g >= Math.abs(c - b),
                    o = g >= Math.abs(r - m), a = g >= Math.abs(h - v),
                    s &&
                        (i.position.top =
...
t.widget('ui.droppable', {
  ...
  _create: function() {
    ...
    this.proportions =
        function() {
      return arguments.length ? (e = arguments[0], undefined) :
          e                   ? e :
                                e = {
    ...
    return s && (s.currentItem || s.element)[0] !== this.element[0] ?
        (this.element.find(':data(ui-droppable)')
             ...
             .each(function() {
               ...
               return e.options.greedy && !e.options.disabled &&
                       e.options.scope === s.options.scope &&
                       e.accept.call(
                           e.element[0], s.currentItem || s.element) &&
                       t.ui.intersect(
                           s, t.extend(e, {offset: e.element.offset()}),
                           e.options.tolerance) ?
                   (n = !0, !1) :
                   undefined
             }),
...
t.widget('ui.resizable', t.ui.mouse, {
  ...
  _create: function() {
    ...
    if (this.element.addClass('ui-resizable'), t.extend(this, {
      ...
      for ('all' === this.handles && (this.handles = 'n,e,s,w,se,sw,ne,nw'),
           e = this.handles.split(','), this.handles = {}, i = 0;
           e.length > i; i++)
        s = t.trim(e[i]), o = 'ui-resizable-' + s,
  ...
  _mouseStart: function(i) {
    ...
    return this.resizing = !0,
           ...
           this._renderProxy(), s = e(this.helper.css('left')),
  ...
  _mouseDrag: function(e) {
    var i, s = this.helper, n = {}, o = this.originalMousePosition,
           ...
           l = this.size.width, c = this.size.height, u = e.pageX - o.left || 0,
  ...
  _mouseStop: function(e) {
    ...
    return this._helper &&
               (i = this._proportionallyResizeElements,
                ...
                c.helper.height(c.size.height), c.helper.width(c.size.width),
  ...
  _updateVirtualBoundaries: function(t) {
    ...
    (this._aspectRatio || t) &&
        (e = a.minHeight * this.aspectRatio, n = a.minWidth / this.aspectRatio,
         s = a.maxHeight * this.aspectRatio, o = a.maxWidth / this.aspectRatio,
  ...
  _updateRatio: function(t) {
    ...
    return i(t.height) ? t.width = t.height * this.aspectRatio :
  ...
  _respectSize: function(t) {
    var e = this._vBoundaries, s = this.axis,
        ...
        u = /nw|ne|n/.test(s);
    return a && (t.width = e.minWidth), r && (t.height = e.minHeight),
           n && (t.width = e.maxWidth), o && (t.height = e.maxHeight),
      ...
      for (t = 0; this._proportionallyResizeElements.length > t; t++) {
        if (n = this._proportionallyResizeElements[t], !this.borderDif)
          for (this.borderDif = [],
              i =
                   [
                     n.css('borderTopWidth'), n.css('borderRightWidth'),
                     n.css('borderBottomWidth'), n.css('borderLeftWidth')
                   ],
              s =
                   [
                     n.css('paddingTop'), n.css('paddingRight'),
                     n.css('paddingBottom'), n.css('paddingLeft')
                   ],
              e = 0;
               i.length > e; e++)
            this.borderDif[e] =
  ...
  ui: function() {
    ...
    t.ui.plugin.add('resizable', 'animate', {
      stop: function(e) {
        var i = t(this).data('ui-resizable'), s = i.options,
            ...
            null,
            c = parseInt(i.element.css('top'), 10) +
    ...
    t.ui.plugin.add('resizable', 'containment', {
      start: function() {
        var i, s, n, o, a, r, h, l = t(this).data('ui-resizable'),
                                 c = l.options, u = l.element,
                                 d = c.containment,
                                 p = d instanceof t ? d.get(0) :
            /parent/.test(d)                        ? u.parent().get(0) :
                                                      d;
        p &&
            (l.containerElement = t(p),
             /document/.test(d) || d === document ?
                 ...
                 (i = t(p), s = [],
                  ...
                  l.containerPosition = i.position(), l.containerSize = {
                  ...
                  h = t.ui.hasScroll(p) ? p.scrollHeight : o, l.parentData = {
                    element: p,
                    left: n.left,
                    top: n.top,
                    width: r,
    ...
    t.ui.plugin.add('resizable', 'alsoResize', {
      ...
      resize: function(e, i) {
        var s = t(this).data('ui-resizable'), n = s.options, o = s.originalSize,
            ...
            h = function(e, s) {
              t(e).each(function() {
                var e = t(this), n = t(this).data('ui-resizable-alsoresize'),
                    o = {},
                    a = s && s.length ? s :
    ...
    t.ui.plugin.add('resizable', 'grid', {
      resize: function() {
        ...
        i.grid = r, m && (d += h), v && (p += l), f && (d -= h), g && (p -= l),
        /^(se|s|e)$/.test(a) ?
            ...
            (p - l > 0 ?
                 ...
                 (e.size.height = l, e.position.top = o.top + n.height - l),
             d - h > 0 ?
                 (e.size.width = d, e.position.left = o.left - c) :
                 (e.size.width = h, e.position.left = o.left + n.width - h))
      }
    })
    }(jQuery),
    function(t) {
t.widget('ui.selectable', t.ui.mouse, {
  ...
  _create: function() {
    ...
    this.element.addClass('ui-selectable'),
        ...
        this.refresh =
            function() {
          e = t(i.options.filter, i.element[0]), e.addClass('ui-selectee'),
          e.each(function() {
        ...
        this.refresh(), this.selectees = e.addClass('ui-selectee'),
        this._mouseInit(),
         ...
         this.selectees.filter('.ui-selected').each(function() {
           ...
           e.metaKey || e.ctrlKey ||
               (s.$element.removeClass('ui-selected'), s.selected = !1,
                s.$element.addClass('ui-unselecting'), s.unselecting = !0,
         ...
         t(e.target).parents().addBack().each(function() {
           ...
           return n ?
               (s = !e.metaKey && !e.ctrlKey ||
                ...
                n.$element.removeClass(s ? 'ui-unselecting' : 'ui-selected')
...
t.widget('ui.sortable', t.ui.mouse, {
  ...
  _create: function() {
    ...
    this.refresh(),
    this.floating =
        this.items.length ? 'x' === t.axis || i(this.items[0].item) : !1,
        ...
        a.cursor && 'auto' !== a.cursor &&
            (o = this.document.find('body'),
             ...
             this.storedStylesheet =
                 t('<style>*{ cursor: ' + a.cursor + ' !important; }</style>')
                     .appendTo(o)),
        a.opacity &&
  ...
  _intersectsWithPointer: function(t) {
    ...
    return n ? this.floating ? a && 'right' === a || 'down' === o ? 2 : 1 :
                               o && ('down' === o ? 2 : 1) :
               !1
  },
  _intersectsWithSides: function(t) {
    var i =
        ...
        s =
            e(this.positionAbs.left + this.offset.click.left,
              t.left + t.width / 2, t.width),
        n = this._getDragVerticalDirection(),
        o = this._getDragHorizontalDirection();
    return this.floating && o ? 'right' === o && s || 'left' === o && !s :
                                n && ('down' === n && i || 'up' === n && !i)
  },
      ...
      if (1 === this.containers.length)
        ...
        for (a = 1e4, r = null, p = f.floating || i(this.currentItem),
          ...
          t.contains(this.containers[g].element[0], this.items[o].item[0]) &&
              ...
              (!p ||
               e(this.positionAbs.top + this.offset.click.top,
                 this.items[o].top, this.items[o].height)) &&
              (u = this.items[o].item.offset()[h], d = !1,
               Math.abs(u - c) > Math.abs(u + this.items[o][l] - c) &&
                   (d = !0, u += this.items[o][l]),
               a > Math.abs(u - c) &&
                   (a = Math.abs(u - c), r = this.items[o],
                    this.direction = d ? 'up' : 'down'));
        if (!r && !this.options.dropOnEmpty) return;
        if (this.currentContainer === this.containers[g]) return;
        r ? this._rearrange(s, r, null, !0) :
  ...
  _clear: function(t, e) {
    ...
    if (this.storedCursor &&
      ...
      if (!e) {
        for (this._trigger('beforeStop', t, this._uiHash()), s = 0;
             n.length > s; s++)
          n[s].call(this, t);
           ...
           toggleClass: function(i) {
             return function(s, n, o, a, r) {
               return 'boolean' == typeof n || n === e ?
                   o ? t.effects.animateClass.call(
                           this, n ? {add: s} : {remove: s}, o, a, r) :
   ...
   function() {
     ...
     t.extend(t.effects, {
       ...
       createWrapper: function(e) {
         ...
         return e.wrap(s), (e[0] === o || t.contains(e[0], o)) && t(o).focus(),
                s = e.parent(),
       ...
       setTransition: function(e, i, s, n) {
         ...
         t.fn.extend({
           effect: function() {
             ...
             return t.fx.off || !a ?
                 n ? this[n](i.duration, i.complete) : this.each(function() {
...
var e = 0, i = {}, s = {};
i
    .height = i.paddingTop = i.paddingBottom = i.borderTopWidth =
    i.borderBottomWidth = 'hide',
   s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth =
       s.borderBottomWidth = 'show',
   t.widget('ui.accordion', {
     ...
     _create: function() {
       ...
       this._processPanels(), 0 > e.active && (e.active += this.headers.length),
       this._refresh()
     },
     ...
     _processPanels: function() {
       this.headers =
           this.element.find(this.options.header)
               .addClass(
     ...
     _refresh: function() {
       ...
       this._createIcons(), this._setupEvents(s.event),
       'fill' === n ?
     ...
     _eventHandler: function(e) {
       var i = this.options, s = this.active, n = t(e.currentTarget),
           o = n[0] === s[0], a = o && i.collapsible, r = a ? t() : n.next(),
           h = s.next(),
       ...
       e.preventDefault(),
           ...
           (i.active = a ? !1 : this.headers.index(n),
            this.active = o ? t() : n, this._toggle(l),
            s.removeClass('ui-accordion-header-active ui-state-active'),
            i.icons &&
                s.children('.ui-accordion-header-icon')
                    .removeClass(i.icons.activeHeader)
                    .addClass(i.icons.header),
            o ||
                (n.removeClass('ui-corner-all')
                     .addClass(
                         'ui-accordion-header-active ui-state-active ui-corner-top'),
                 i.icons &&
                     n.children('.ui-accordion-header-icon')
     ...
     _toggle: function(e) {
       ...
       this.prevShow.add(this.prevHide).stop(!0, !0),
           ...
           this.options.animate ? this._animate(i, s, e) :
     ...
     _animate: function(t, e, n) {
       ...
       return 'number' == typeof d && (r = d), 'string' == typeof d && (a = d),
              a = a || d.easing || u.easing, r = r || d.duration || u.duration,
              e.length ?
                  t.length ?
                  (o = t.show().outerHeight(), e.animate(i, {
                    duration: r,
                    easing: a,
                    step: function(t, e) {
                      e.now = Math.round(t)
...
t.widget('ui.autocomplete', {
  ...
  _create: function() {
    ...
    this._on(this.element, {
      ...
      input: function(t) {
        return s ? (s = !1, t.preventDefault(), undefined) :
      ...
      blur: function(t) {
        return this.cancelBlur ? (delete this.cancelBlur, undefined) :
                                 (clearTimeout(this.searching), this.close(t),
                                  this._change(t), undefined)
      }
    }),
    this._initSource(),
    this.menu = t('<ul>')
      ...
      mousedown: function(e) {
        ...
        t(e.target).closest('.ui-menu-item').length || this._delay(function() {
          ...
          this.document.one('mousedown', function(s) {
            s.target === e.element[0] || s.target === i ||
                t.contains(i, s.target) || e.close()
          })
        })
      },
  ...
  _search: function(t) {
    this.pending++, this.element.addClass('ui-autocomplete-loading'),
  ...
  _suggest: function(e) {
    ...
    this._renderMenu(i, e),
        this.isNewMenu = !0, this.menu.refresh(), i.show(), this._resizeMenu(),
    ...
    t.widget('ui.autocomplete', t.ui.autocomplete, {
      ...
      __response: function(t) {
        ...
        this._superApply(arguments),
            ...
            (e = t && t.length ? this.options.messages.results(t.length) :
...
t.widget('ui.button', {
  ...
  _create: function() {
    ...
    var s = this, a = this.options,
        ...
        h = r ? '' : 'ui-state-active';
    null === a.label &&
        (a.label = 'input' === this.type ? this.buttonElement.val() :
                                           this.buttonElement.html()),
        this._hoverable(this.buttonElement),
        this.buttonElement.addClass(i)
            .attr('role', 'button')
            .bind(
        ...
        (this.buttonElement
             .bind(
                 ...
                 function() {
                   return a.disabled ?
                       !1 :
                       (t(this).addClass('ui-state-active'), e = this,
  ...
  _determineButtonType: function() {
    ...
    this.type = this.element.is('[type=checkbox]') ? 'checkbox' :
        this.element.is('[type=radio]')            ? 'radio' :
  ...
  _destroy: function() {
    this.element.removeClass('ui-helper-hidden-accessible'),
        this.buttonElement.removeClass(i + ' ui-state-active ' + s)
            .removeAttr('role')
  ...
  _resetButton: function() {
    ...
    n.primary || n.secondary ?
        (this.options.text &&
         ...
         n.primary &&
             e.prepend(
                 '<span class=\'ui-button-icon-primary ui-icon ' + n.primary +
                 '\'></span>'),
         n.secondary &&
             e.append(
...
t.extend(i.prototype, {
  ...
  _newInst: function(e, i) {
    ...
    return {
      id: n, input: e, selectedDay: 0, selectedMonth: 0, selectedYear: 0,
  ...
  _attachments: function(e, i) {
    ...
    i.append && i.append.remove(),
        ...
        (n = this._get(i, 'buttonText'), o = this._get(i, 'buttonImage'),
         ...
         e[r ? 'before' : 'after'](i.trigger), i.trigger.click(function() {
  ...
  _inlineDatepicker: function(e, i) {
    var s = t(e);
    s.hasClass(this.markerClassName) ||
        (s.addClass(this.markerClassName).append(i.dpDiv), t.data(e, a, i),
  ...
  _dialogDatepicker: function(e, i, s, o, r) {
    ...
    return p ||
               (this.uuid += 1, h = 'dp' + this.uuid,
                ...
                p.settings = {}, t.data(this._dialogInput[0], a, p)),
           n(p.settings, o || {}),
           ...
           p.settings.onSelect = s, this._inDialog = !0,
  ...
  _destroyDatepicker: function(e) {
    ...
    s.hasClass(this.markerClassName) &&
        (i = e.nodeName.toLowerCase(), t.removeData(e, a),
  ...
  _optionDatepicker: function(i, s, o) {
    ...
    return 2 === arguments.length && 'string' == typeof s ?
        'defaults' === s ? t.extend({}, t.datepicker._defaults) :
            c ? 'all' === s ? t.extend({}, c.settings) : this._get(c, s) :
                null :
        (a = s || {}, 'string' == typeof s && (a = {}, a[s] = o),
         c &&
             (this._curInst === c && this._hideDatepicker(),
              r = this._getDateDatepicker(i, !0),
              h = this._getMinMaxDate(c, 'min'),
              l = this._getMinMaxDate(c, 'max'), n(c.settings, a),
              null !== h && a.dateFormat !== e && a.minDate === e &&
                  (c.settings.minDate = this._formatDate(c, h)),
              null !== l && a.dateFormat !== e && a.maxDate === e &&
                  (c.settings.maxDate = this._formatDate(c, l)),
              'disabled' in a &&
                  (a.disabled ? this._disableDatepicker(i) :
                                this._enableDatepicker(i)),
              this._attachments(t(i), c), this._autoSize(c),
              this._setDate(c, r), this._updateAlternate(c),
  ...
  _showDatepicker: function(e) {
    if (e = e.target || e,
      ...
      s = t.datepicker._get(i, 'beforeShow'), o = s ? s.apply(e, [e, i]) : {},
      o !== !1 &&
          (n(i.settings, o), i.lastVal = null, t.datepicker._lastInput = e,
           ...
           t.datepicker._pos = null, i.dpDiv.empty(),
           i.dpDiv.css(
               {position: 'absolute', display: 'block', top: '-1000px'}),
           t.datepicker._updateDatepicker(i),
           r = t.datepicker._checkOffset(i, r, a), i.dpDiv.css({
  ...
  _hideDatepicker: function(e) {
    ...
    !r || e && r !== t.data(e, a) ||
        this._datepickerShowing &&
            (i = this._get(r, 'showAnim'), s = this._get(r, 'duration'),
             n =
                 function() {
  ...
  parseDate: function(i, s, n) {
    ...
    var o, a, r, h,
        ...
        g = (n ? n.monthNames : null) || this._defaults.monthNames, m = -1,
        v = -1, _ = -1, b = -1, y = !1, w = function(t) {
      ...
      if (y)
        ...
        switch (i.charAt(o)) {
          ...
          case 'y':
            ...
            break;
          case '@':
            h = new Date(x('@')), m = h.getFullYear(), v = h.getMonth() + 1,
            _ = h.getDate();
            break;
          case '!':
            h = new Date((x('!') - this._ticksTo1970) / 1e4),
            m = h.getFullYear(), v = h.getMonth() + 1, _ = h.getDate();
            break;
          case '\'':
            w('\'') ? D() : y = !0;
            break;
    ...
    if (-1 === m ? m = (new Date).getFullYear() :
                ...
                (m += (new Date).getFullYear() -
                     (new Date).getFullYear() % 100 + (u >= m ? 0 : -100)),
        b > -1)
      for (v = 1, _ = b;;) {
  ...
  _generateHTML: function(t) {
    var e, i, s, n, o, a, r, h, l, c, u, d, p, f, g, m, v, _, b, y, w, x, k, D,
        C, I, P, T, M, S, z, A, E, H, N, W, O, F, R,
        L = new Date,
        ...
        q = this._getNumberOfMonths(t), U = this._get(t, 'showCurrentAtPos'),
        Q = this._get(t, 'stepMonths'), X = 1 !== q[0] || 1 !== q[1],
        $ = this._daylightSavingAdjust(
            t.currentDay ?
                new Date(t.currentYear, t.currentMonth, t.currentDay) :
                new Date(9999, 9, 9)),
        G = this._getMinMaxDate(t, 'min'), J = this._getMinMaxDate(t, 'max'),
        Z = t.drawMonth - U, te = t.drawYear;
    if (0 > Z && (Z += 12, te--), J)
      for (e = this._daylightSavingAdjust(new Date(
               J.getFullYear(), J.getMonth() - q[0] * q[1] + 1, J.getDate())),
          e = G && G > e ? G : e;
    ...
    for (
       ...
       i = K ? this.formatDate(
                   i, this._daylightSavingAdjust(new Date(te, Z - Q, 1)),
       ...
       n = K ? this.formatDate(
                   n, this._daylightSavingAdjust(new Date(te, Z + Q, 1)),
                   this._getFormatConfig(t)) :
               n,
       ...
       l = B ? '<div class=\'ui-datepicker-buttonpane ui-widget-content\'>' +
                (Y ? h : '') +
                (this._isInRange(t, r) ?
       ...
       _ = this._get(t, 'selectOtherMonths'), b = this._getDefaultDate(t),
       y = '', x = 0;
        q[0] > x; x++) {
      for (k = '', this.maxRows = 4, D = 0; q[1] > D; D++) {
        ...
        for (
            ...
            '<div class=\'ui-datepicker-header ui-widget-header ui-helper-clearfix' +
                I + '\'>' + (/all|left/.test(I) && 0 === x ? Y ? o : s : '') +
                (/all|right/.test(I) && 0 === x ? Y ? s : o : '') +
                this._generateMonthYearHeader(
                    t, Z, te, G, J, x > 0 || D > 0, f, g) +
                '</div><table class=\'ui-datepicker-calendar\'><thead>' +
                '<tr>',
            T = u ? '<th class=\'ui-datepicker-week-col\'>' +
        ...
        for (P += T + '</tr></thead><tbody>',
             ...
             A = Math.ceil((z + S) / 7),
             E = X ? this.maxRows > A ? this.maxRows : A : A, this.maxRows = E,
             H = this._daylightSavingAdjust(new Date(te, Z, 1 - z)), N = 0;
             E > N; N++) {
          for (P += '<tr>',
               W = u ? '<td class=\'ui-datepicker-week-col\'>' +
                       this._get(t, 'calculateWeek')(H) + '</td>' :
                       '',
               w = 0;
               7 > w; w++)
            ...
            W += '<td class=\'' +
                ...
                (H.getTime() === C.getTime() && Z === t.selectedMonth &&
                             t._keyEvent ||
                         b.getTime() === H.getTime() &&
                             b.getTime() === C.getTime() ?
                     ' ' + this._dayOverClass :
                ...
                (R ? '' :
                     ' data-handler=\'selectDay\' data-event=\'click\' data-month=\'' +
                         H.getMonth() + '\' data-year=\'' + H.getFullYear() +
                         '\'') +
                '>' +
                (F && !v ? '&#xa0;' :
                     R   ? '<span class=\'ui-state-default\'>' + H.getDate() +
                         '</span>' :
  ...
  _generateMonthYearHeader: function(t, e, i, s, n, o, a, r) {
    var h, l, c, u, d, p, f, g,
        m = this._get(t, 'changeMonth'), v = this._get(t, 'changeYear'),
  ...
  _formatDate: function(t, e, i, s) {
    ...
    t.datepicker.uuid = (new Date).getTime(), t.datepicker.version = '1.10.4'
    }(jQuery),
    function(t) {
var e = {
  buttons: !0,
...
t.widget('ui.dialog', {
  ...
  _appendTo: function() {
    var e = this.options.appendTo;
    return e && (e.jquery || e.nodeType) ? t(e) :
  ...
  _moveToTop: function(t, e) {
    var i =
        !!this.uiDialog.nextAll(':visible').insertBefore(this.uiDialog).length;
  ...
  open: function() {
    ...
    return this._isOpen ?
        ...
        (this._isOpen = !0, this.opener = t(this.document[0].activeElement),
        ...
        if (e.keyCode === t.ui.keyCode.TAB) {
          ...
          e.target !== n[0] && e.target !== this.uiDialog[0] || e.shiftKey ?
              e.target !== s[0] && e.target !== this.uiDialog[0] ||
                  !e.shiftKey || (n.focus(1), e.preventDefault()) :
           ...
           t.isEmptyObject(i) || t.isArray(i) && !i.length ?
               ...
               (t.each(
                    ...
                    function(i, s) {
                      ...
                      s = t.extend({type: 'button'}, s), n = s.click,
                      s.click =
                          function() {
                        n.apply(e.element[0], arguments)
                      },
                      o = {icons: s.icons, text: s.showText}, delete s.icons,
                      delete s.showText,
                      t('<button></button>', s)
                          .button(o)
                ...
                this.uiDialogButtonPane.appendTo(this.uiDialog), undefined)
  },
  _makeDraggable: function() {
    ...
    this.uiDialog.draggable({
      ...
      start: function(s, n) {
        t(this).addClass('ui-dialog-dragging'), i._blockFrames(),
      ...
      stop: function(n, o) {
        ...
        t(this).removeClass('ui-dialog-dragging'), i._unblockFrames(),
  ...
  _makeResizable: function() {
    ...
    this.uiDialog
        .resizable({
          ...
          handles: a,
          start: function(s, n) {
            t(this).addClass('ui-dialog-resizing'), i._blockFrames(),
          ...
          stop: function(n, o) {
            s.height = t(this).height(), s.width = t(this).width(),
            t(this).removeClass('ui-dialog-resizing'), i._unblockFrames(),
  ...
  _destroyOverlay: function() {
    this.options.modal && this.overlay &&
        (t.ui.dialog.overlayInstances--,
    ...
    t.uiBackCompat !== !1 && t.widget('ui.dialog', t.ui.dialog, {
      _position: function() {
        ...
        i ? (('string' == typeof i || 'object' == typeof i && '0' in i) &&
                 (s = i.split ? i.split(' ') : [i[0], i[1]],
                  ...
                  i = {
                    my: s[0] + (0 > n[0] ? n[0] : '+' + n[0]) + ' ' + s[1] +
                        (0 > n[1] ? n[1] : '+' + n[1]),
                    at: s.join(' ')
                  }),
             i = t.extend({}, t.ui.dialog.prototype.options.position, i)) :
            i = t.ui.dialog.prototype.options.position,
            e = this.uiDialog.is(':visible'), e || this.uiDialog.show(),
            this.uiDialog.position(i), e || this.uiDialog.hide()
      }
    })
    }(jQuery),
    function(t) {
...
t.effects.effect.blind = function(s, n) {
  ...
  h.parent().is('.ui-effects-wrapper') ? t.effects.save(h.parent(), l) :
                                         t.effects.save(h, l),
      h.show(), o = t.effects.createWrapper(h).css({overflow: 'hidden'}),
                a = o[p](), r = parseFloat(o.css(f)) || 0, m[p] = v ? a : 0,
                g ||
      (h.css(d ? 'bottom' : 'right', 0).css(d ? 'top' : 'left', 'auto').css({
                  position: 'absolute'
                }),
       m[f] = v ? r : a + r),
                v && (o.css(p, 0), g || o.css(f, r + a)), o.animate(m, {
                  duration: s.duration,
                  easing: s.easing,
                  queue: !1,
                  complete: function() {
                    'hide' === c && h.hide(), t.effects.restore(h, l),
                        t.effects.removeWrapper(h), n()
                  }
                })
}
    }(jQuery),
...
t.effects.effect.bounce = function(e, i) {
  ...
  for ((c || l) && r.push('opacity'), t.effects.save(a, r), a.show(),
       ...
       l && (d /= Math.pow(2, p - 1)), o = {}, o[v] = 0, s = 0;
       p > s; s++)
    n = {}, n[v] = (_ ? '-=' : '+=') + d, a.animate(n, g, m).animate(o, g, m),
    d = l ? 2 * d : d / 2;
...
t.effects.effect.clip = function(e, i) {
  ...
  t.effects.save(a, r), a.show(),
      s = t.effects.createWrapper(a).css({overflow: 'hidden'}),
      n = 'IMG' === a[0].tagName ? s : a, o = n[d](),
      l && (n.css(d, 0), n.css(p, o / 2)), f[d] = l ? o : 0,
      f[p] = l ? 0 : o / 2, n.animate(f, {
        queue: !1,
        duration: e.duration,
        easing: e.easing,
        complete: function() {
          l || a.hide(), t.effects.restore(a, r), t.effects.removeWrapper(a),
              i()
        }
      })
}
...
t.effects.effect.drop = function(e, i) {
  var s, n = t(this),
         ...
         u = {opacity: r ? 1 : 0};
  t.effects.save(n, o), n.show(), t.effects.createWrapper(n),
      ...
      n.animate(u, {
        ...
        easing: e.easing,
        complete: function() {
          'hide' === a && n.hide(), t.effects.restore(n, o),
              t.effects.removeWrapper(n), i()
        }
      })
}
    }(jQuery),
...
t.effects.effect.explode = function(e, i) {
  ...
  var o, a, r, h, l, c,
      u = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, d = u, p = t(this),
      f = t.effects.setMode(p, e.mode || 'hide'), g = 'show' === f,
      m = p.show().css('visibility', 'hidden').offset(),
      v = Math.ceil(p.outerWidth() / d), _ = Math.ceil(p.outerHeight() / u),
      b = [];
  for (o = 0; u > o; o++)
    for (h = m.top + o * _, c = o - (u - 1) / 2, a = 0; d > a; a++)
      r = m.left + a * v, l = a - (d - 1) / 2,
      p.clone()
          .appendTo('body')
          .wrap('<div></div>')
          .css({
...
t.effects.effect.fold = function(e, i) {
  var s, n,
      ...
      f = p ? ['width', 'height'] : ['height', 'width'], g = e.duration / 2,
      m = {}, v = {};
  t.effects.save(o, a), o.show(),
...
t.effects.effect.highlight = function(e, i) {
  ...
  'hide' === o && (a.opacity = 0), t.effects.save(s, n),
      s.show()
...
t.effects.effect.pulsate = function(e, i) {
  ...
  for ((a || !n.is(':visible')) && (n.css('opacity', 0).show(), u = 1), s = 1;
       l > s; s++)
...
t.effects.effect.puff = function(e, i) {
  ...
  n.effect = 'size', n.queue = !1, n.complete = i,
  'effect' !== o && (n.origin = h || ['middle', 'center'], n.restore = !0),
  n.from = e.from ||
      ('show' === o ? {height: 0, width: 0, outerHeight: 0, outerWidth: 0} : l),
  n.to = {
    height: l.height * c.y,
    width: l.width * c.x,
  ...
  'show' === p && a.show(),
      ...
      (u = u.concat(['marginTop', 'marginBottom']).concat(c),
       d = d.concat(['marginLeft', 'marginRight']), l = r.concat(u).concat(d),
      ...
      a.animate(a.to, {
        ...
        complete: function() {
          0 === a.to.opacity && a.css('opacity', a.from.opacity),
              'hide' === p && a.hide(), t.effects.restore(a, _),
              f ||
              ('static' === v ?
                   a.css(
                       {position: 'relative', top: a.to.top, left: a.to.left}) :
                   t.each(
                       ['top', 'left'],
                       function(t, e) {
...
t.effects.effect.shake = function(e, i) {
  var s, n = t(this),
         ...
         p = 'up' === r || 'left' === r, f = {}, g = {}, m = {}, v = n.queue(),
         _ = v.length;
  for (t.effects.save(n, o), n.show(), t.effects.createWrapper(n),
       f[d] = (p ? '-=' : '+=') + h, g[d] = (p ? '+=' : '-=') + 2 * h,
       m[d] = (p ? '-=' : '+=') + 2 * h, n.animate(f, u, e.easing), s = 1;
       l > s; s++)
...
t.effects.effect.transfer = function(e, i) {
  var s = t(this), n = t(e.to), o = 'fixed' === n.css('position'),
      a = t('body'), r = o ? a.scrollTop() : 0, h = o ? a.scrollLeft() : 0,
      l = n.offset(), c = {
        top: l.top - r,
        left: l.left - h,
...
t.widget('ui.menu', {
        ...
        !this.mouseHandled && i.not('.ui-state-disabled').length &&
            (this.select(e),
             ...
             i.has('.ui-menu').length ? this.expand(e) :
                     ...
                     t(this.document[0].activeElement)
                         .closest('.ui-menu')
                         .length &&
  ...
  _keydown: function(e) {
    ...
    switch (e.keyCode) {
      ...
      case t.ui.keyCode.ESCAPE:
        ...
        break;
      default:
        h = !1, n = this.previousFilter || '',
        o = String.fromCharCode(e.keyCode), a = !1,
        clearTimeout(this.filterTimer), o === n ? a = !0 : o = n + o,
        r = RegExp('^' + i(o), 'i'),
        s = this.activeMenu.children('.ui-menu-item').filter(function() {
          return r.test(t(this).children('a').text())
        }),
        s = a && -1 !== s.index(this.active.next()) ?
            this.active.nextAll('.ui-menu-item') :
            s,
        s.length ||
            (o = String.fromCharCode(e.keyCode), r = RegExp('^' + i(o), 'i'),
             s = this.activeMenu.children('.ui-menu-item').filter(function() {
               return r.test(t(this).children('a').text())
             })),
  ...
  refresh: function() {
    ...
    this.element.toggleClass(
        ...
        e.children(':not(.ui-menu-item):has(a)')
  ...
  blur: function(t, e) {
    e || clearTimeout(this.timer),
        ...
        (this.active.children('a').removeClass('ui-state-focus'),
         this.active = null, this._trigger('blur', t, {item: this.active}))
  },
  ...
  _move: function(t, e, i) {
    ...
    this.active &&
        (s = 'first' === t || 'last' === t ?
             this.active['first' === t ? 'prevAll' : 'nextAll']('.ui-menu-item')
                 .eq(-1) :
             ...
             (this._hasScroll() ?
                  ...
                  this.focus(
                      ...
                      this.activeMenu.children(
                          '.ui-menu-item')[this.active ? 'last' : 'first']())),
         undefined) :
        ...
        (this.isFirstItem() ||
             (this._hasScroll() ?
                  (s = this.active.offset().top, n = this.element.height(),
                   ...
                   this.focus(e, i)) :
                  this.focus(
                      e, this.activeMenu.children('.ui-menu-item').first())),
         undefined) :
        (this.next(e), undefined)
  },
  _hasScroll: function() {
...
t.position = {
  scrollbarWidth: function() {
    ...
    return t('body').append(n),
           i = a.offsetWidth, n.css('overflow', 'scroll'), s = a.offsetWidth,
  ...
  getWithinInfo: function(e) {
    ...
    return {
      element: i, isWindow: s, isDocument: n,
          offset: i.offset() || {left: 0, top: 0}, scrollLeft: i.scrollLeft(),
          scrollTop: i.scrollTop(), width: s ? i.width() : i.outerWidth(),
    ...
    t.fn.position =
      ...
      return _ = n(b), b[0].preventDefault && (e.at = 'left top'), p = _.width,
             g = _.height, m = _.offset, v = t.extend({}, m),
             t.each(
                 ['my', 'at'],
                 function() {
                   var t, i, s = (e[this] || '').split(' ');
                   1 === s.length &&
                       (s = l.test(s[0]) ? s.concat(['center']) :
                            c.test(s[0]) ? ['center'].concat(s) :
                                           ['center', 'center']),
                       s[0] = l.test(s[0]) ? s[0] : 'center',
                       s[1] = c.test(s[1]) ? s[1] : 'center', t = u.exec(s[0]),
                       i = u.exec(s[1]), k[this] = [t ? t[0] : 0, i ? i[0] : 0],
                       e[this] = [d.exec(s[0])[0], d.exec(s[1])[0]]
                 }),
             1 === x.length && (x[1] = x[0]),
             'right' === e.at[0] ? v.left += p :
                                   'center' === e.at[0] && (v.left += p / 2),
             'bottom' === e.at[1] ? v.top += g :
                                    'center' === e.at[1] && (v.top += g / 2),
             o = i(k.at, p, g), v.left += o[0], v.top += o[1],
             this.each(function() {
                   ...
                   t.each(['left', 'top'], function(i, s) {
                     t.ui.position[x[i]] && t.ui.position[x[i]][s](I, {
                       ...
                       elem: c
                         ...
                         var i = m.left - I.left, s = i + p - u,
                             n = m.top - I.top, o = n + g - d, h = {
                               target: {
                                 element: b,
                                 left: m.left,
                                 top: m.top,
                         ...
                         u > p && p > r(i + s) && (h.horizontal = 'center'),
                             ...
                             h.important = a(r(i), r(s)) > a(r(n), r(o)) ?
                             'horizontal' :
                             'vertical',
      ...
      fit: {
        left: function(t, e) {
          var i, s = e.within, n = s.isWindow ? s.scrollLeft : s.offset.left,
                 o = s.width, r = t.left - e.collisionPosition.marginLeft,
                 h = n - r, l = r + e.collisionWidth - o - n;
          e.collisionWidth > o ?
              h > 0 && 0 >= l ?
              (i = t.left + h + e.collisionWidth - o - n, t.left += h - i) :
              t.left = l > 0 && 0 >= h ? n :
                      h > l            ? n + o - e.collisionWidth :
                                         n :
              h > 0 ? t.left += h :
              l > 0 ? t.left -= l :
        ...
        top: function(t, e) {
          var i, s = e.within, n = s.isWindow ? s.scrollTop : s.offset.top,
                 o = e.within.height, r = t.top - e.collisionPosition.marginTop,
                 h = n - r, l = r + e.collisionHeight - o - n;
          e.collisionHeight > o ?
              h > 0 && 0 >= l ?
              (i = t.top + h + e.collisionHeight - o - n, t.top += h - i) :
              t.top = l > 0 && 0 >= h ? n :
                      h > l           ? n + o - e.collisionHeight :
                                        n :
              h > 0 ? t.top += h :
              l > 0 ? t.top -= l :
      ...
      flip: {
        ...
        top: function(t, e) {
          ...
          0 > c ? (s = t.top + p + f + g + e.collisionHeight - a - o,
                   t.top + p + f + g > c && (0 > s || r(c) > s) &&
                       (t.top += p + f + g)) :
                  u > 0 &&
                  (i = t.top - e.collisionPosition.marginTop + p + f + g - h,
                   t.top + p + f + g > u && (i > 0 || u > r(i)) &&
                       (t.top += p + f + g))
        }
      },
      flipfit: {
    ...
    function() {
      ...
      e.appendChild(r),
          i = a || document.documentElement, i.insertBefore(e, i.firstChild),
          r.style.cssText = 'position: absolute; left: 10.7432222px;',
          n = t(r).offset().left, t.support.offsetFractions = n > 10 && 11 > n,
          e.innerHTML = '', i.removeChild(e)
    }()
    }(jQuery),
    function(t, e) {
t.widget('ui.progressbar', {
  ...
  _create: function() {
    ...
    this.valueDiv =
        t('<div class=\'ui-progressbar-value ui-widget-header ui-corner-left\'></div>')
  ...
  value: function(t) {
    return t === e ? this.options.value :
                     (this.options.value = this._constrainedValue(t),
                      this._refreshValue(), e)
  },
  _constrainedValue: function(t) {
    return t === e && (t = this.options.value), this.indeterminate = t === !1,
                                                'number' != typeof t && (t = 0),
                                                this.indeterminate ?
               !1 :
  ...
  _refreshValue: function() {
    ...
    this.valueDiv.toggle(this.indeterminate || e > this.min)
        ...
        (this.element.removeAttr('aria-valuenow'),
         this.overlayDiv ||
             (this.overlayDiv =
                  t('<div class=\'ui-progressbar-overlay\'></div>')
...
t.widget('ui.slider', t.ui.mouse, {
  ...
  _createHandles: function() {
    ...
    for (i = s.values && s.values.length || 1,
        n.length > i && (n.slice(i).remove(), n = n.slice(0, i)), e = n.length;
         i > e; e++)
      a.push(o);
  ...
  _createRange: function() {
    ...
    e.range ?
        (e.range === !0 &&
             (e.values ? e.values.length&& 2 !== e.values.length ?
  ...
  _setupEvents: function() {
    ...
    this._off(t), this._on(t, this._handleEvents), this._hoverable(t),
        this._focusable(t)
  },
  _destroy: function() {
        ...
        (this.elementSize = {
         ...
         r === !1 ?
             ...
             (this._mouseSliding = !0, this._handleIndex = a,
              o.addClass('ui-state-active').focus(), h = o.offset(),
    ...
    this.options.values && this.options.values.length ?
        (s = this.values(e ? 0 : 1),
         ...
         i !== this.values(e) &&
             (n = this.values(), n[e] = i,
              o = this._trigger(
                  'slide', t, {handle: this.handles[e], value: i, values: n}),
              s = this.values(e ? 0 : 1), o !== !1 && this.values(e, i))) :
        i !== this.value() &&
  ...
  _change: function(t, e) {
    if (!this._keySliding && !this._mouseSliding) {
      ...
      this.options.values && this.options.values.length &&
          (i.value = this.values(e), i.values = this.values()),
          this._lastChangedValue = e, this._trigger('change', t, i)
    }
  },
  value: function(t) {
    return arguments.length ?
        (this.options.value = this._trimAlignValue(t), this._refreshValue(),
         this._change(null, 0), undefined) :
        this._value()
  },
  values: function(e, i) {
    var s, n, o;
        ...
        (s = this.value(), n = this._valueMin(), o = this._valueMax(),
         ...
         'max' === a && 'horizontal' === this.orientation &&
             this.range[l ? 'animate' : 'css'](
                 {width: 100 - i + '%'}, {queue: !1, duration: r.animate}),
         'min' === a && 'vertical' === this.orientation &&
             this.range.stop(1, 1)[l ? 'animate' : 'css'](
                 {height: i + '%'}, r.animate),
         'max' === a && 'vertical' === this.orientation &&
             this.range[l ? 'animate' : 'css'](
                 {height: 100 - i + '%'}, {queue: !1, duration: r.animate}))
  },
  _handleEvents: {
    keydown: function(i) {
      ...
      switch (a = this.options.step,
              n = o = this.options.values && this.options.values.length ?
                  this.values(r) :
                  this.value(),
              i.keyCode) {
        case t.ui.keyCode.HOME:
...
t.widget('ui.spinner', {
  ...
  _draw: function() {
    ...
    this.element.attr('role', 'spinbutton'),
        this.buttons = t.find('.ui-spinner-button')
                           .attr('tabIndex', -1)
                           .button()
                           .removeClass('ui-corner-all'),
        this.buttons.height() > Math.ceil(.5 * t.height()) && t.height() > 0 &&
        t.height(t.height()),
  ...
  _setOption: function(t, e) {
    ...
    ('max' === t || 'min' === t || 'step' === t) && 'string' == typeof e &&
        (e = this._parse(e)),
        'icons' === t &&
        (this.buttons.first()
             .find('.ui-icon')
  ...
  value: function(t) {
    return arguments.length ? (e(this._value).call(this, t), void 0) :
...
t.widget('ui.tabs', {
  ...
  _create: function() {
    ...
    this.element.addClass('ui-tabs ui-widget ui-widget-content ui-corner-all')
        ...
        .delegate(
            '.ui-tabs-nav > li', 'mousedown' + this.eventNamespace,
            function(e) {
              t(this).is('.ui-state-disabled') && e.preventDefault()
            })
        .delegate(
            '.ui-tabs-anchor', 'focus' + this.eventNamespace,
            function() {
    ...
    if (!this._handlePageNav(i)) {
      switch (i.keyCode) {
        ...
        case t.ui.keyCode.HOME:
          ...
          break;
        case t.ui.keyCode.SPACE:
          return i.preventDefault(), clearTimeout(this.activating),
                 this._activate(n), e;
        case t.ui.keyCode.ENTER:
          return i.preventDefault(), clearTimeout(this.activating),
                 this._activate(n === this.options.active ? !1 : n), e;
        default:
          return
      }
  ...
  _processTabs: function() {
    ...
    this.panels = t(), this.anchors.each(function(i, n) {
      ...
      s(n) ? (o = n.hash, a = e.element.find(e._sanitizeSelector(o))) :
             (r = e._tabId(l), o = '#' + r, a = e.element.find(o),
              a.length ||
                  (a = e._createPanel(r),
  ...
  _destroy: function() {
    this.xhr && this.xhr.abort(),
        ...
        this.tabs.each(function() {
          ...
          i ? e.attr('aria-controls', i).removeData('ui-tabs-aria-controls') :
    ...
    s(a[0]) ||
        (this.xhr = t.ajax(this._ajaxSettings(a, i, h)),
         this.xhr && 'canceled' !== this.xhr.statusText &&
             (o.addClass('ui-tabs-loading'), r.attr('aria-busy', 'true'),
              this.xhr
                  .success(function(t) {
                    setTimeout(function() {
                  ...
                  .complete(function(t, e) {
                    setTimeout(function() {
                      'abort' === e && n.panels.stop(!1, !0),
                          ...
                          r.removeAttr('aria-busy'), t === n.xhr && delete n.xhr
                    }, 1)
                  })))
  },
...
function i(e) {
  var i = e.data('ui-tooltip-id'),
      s = (e.attr('aria-describedby') || '').split(/\s+/), n = t.inArray(i, s);
...
t.widget('ui.tooltip', {
  ...
  _open: function(i, s, n) {
    ...
    if (n) {
      ...
      s.is('[title]') &&
          (i && 'mouseover' === i.type ? s.attr('title', '') :
                                         s.removeAttr('title')),
          a = this._tooltip(s), e(s, a.attr('id')),
          ...
          (h = this.delayedShow = setInterval(
               ...
               t.fx.interval)),
          this._trigger('open', i, {tooltip: a}), r = {
            keyup: function(e) {
  ...
  close: function(e) {
    ...
    this.closing ||
        (clearInterval(this.delayedShow),
         ...
         this.closing = !0, this._trigger('close', e, {tooltip: o}),
         this.closing = !1)
  },
  _tooltip: function(e) {
    var i = 'ui-tooltip-' + s++,
    ...
    return t('<div>').addClass('ui-tooltip-content').appendTo(n),
           n.appendTo(this.document[0].body), this.tooltips[i] = e, n
  },
  _find: function(e) {
    var i = e.data('ui-tooltip-id');
    return i ? t('#' + i) : t()
  ...
  _destroy: function() {
    ...
    t.each(this.tooltips, function(i, s) {
      var n = t.Event('blur');
      n.target = n.currentTarget = s[0], e.close(n, !0), t('#' + i).remove(),
