...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0), function(e, t, n) {
  function r(n) {
    var r = t.console;
    i[n] ||
        (i[n] = !0, e.migrateWarnings.push(n),
         r && r.warn && !e.migrateMute &&
             (r.warn('JQMIGRATE: ' + n),
  ...
  var i = {};
  e.migrateWarnings = [],
  !e.migrateMute && t.console && t.console.log &&
  ...
  a(e, 'attrFn', o || {}, 'jQuery.attrFn is deprecated'),
      e.attr = function(t, a, i, u) {
        ...
        return u &&
            ...
            e(t)[a](i) :
            ('type' === a && i !== n && l.test(t.nodeName) && t.parentNode &&
                 r('Can\'t change the \'type\' of an input or button in IE 6/7/8'),
             !e.attrHooks[c] && p.test(c) &&
                 (e.attrHooks[c] = {
                   get: function(t, r) {
                     var a, i = e.prop(t, r);
                     return i === !0 ||
  ...
  e.fn.init =
      function(t, n, a) {
    var i;
    return t && 'string' == typeof t && !e.isPlainObject(n) &&
            (i = y.exec(e.trim(t))) && i[0] &&
            ('<' !== t.charAt(0) &&
             ...
             n && n.context && (n = n.context), e.parseHTML) ?
  ...
  e.browser ||
      (g = e.uaMatch(navigator.userAgent), h = {},
       g.browser && (h[g.browser] = !0, h.version = g.version),
       h.chrome ? h.webkit = !0 : h.webkit && (h.safari = !0), e.browser = h),
  ...
  e.sub = function() {
    ...
    e.extend(!0, t, this),
        t.superclass = this, t.fn = t.prototype = this(), t.fn.constructor = t,
  ...
  e.fn.data = function(t) {
    var a, i, o = this[0];
    return !o || 'events' !== t || 1 !== arguments.length ||
            (a = e.data(o, t), i = e._data(o, t),
             a !== n && a !== i || i === n) ?
  ...
  e.event.props && 'attrChange' !== e.event.props[0] &&
      ...
      e.event.add = function(e, t, n, a, i) {
        ...
        return r('jQuery.fn.error() is deprecated'), e.splice(0, 0, 'error'),
               arguments.length ? this.bind.apply(this, e) :
